...
3. Describe los extras entregados y los daños encontrados en los cuadros de
   observaciones (puedes dejarlos vacíos si no aplican).
4. Activa la cámara del inventario, captura tantas fotografías como necesites y
   elimínalas si es necesario.
5. Pide al inquilino escribir su nombre y firmar con el dedo en el recuadro.
6. Activa la cámara frontal para capturar la selfie de verificación.
7. Presiona **Generar PDF** para descargar el inventario. El sistema intentará
...
El PDF resultante coloca dos fotografías por página en alta resolución, muestra
los bloques de observaciones con el nuevo diseño y conserva la imagen
corporativa de Blue Home, el código del inmueble y un resumen claro de la firma
y la selfie final.
